...
- Now also incorporates auth system (only login view enable, since sign up are not open to public)
- Include a NGINX server to handle the user media upload content
